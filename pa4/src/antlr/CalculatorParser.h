...
public:
  ...
  enum {
    RuleProgram = 0, RuleStatement = 1, RuleAssignment = 2, RuleBlock = 3, 
    RulePrintStmt = 4, RuleExpr = 5
  };
  ...
  class  PlusExprContext : public ExprContext {
  public:
    PlusExprContext(ExprContext *ctx);
